...
public class State_Damaged3 : IState
{
    // Damaged state for the Boss enemy type. This state makes the enemy turn to the player once 
    ...
    public State_Damaged3(EnemyController3 owner)
    {
        this.owner = owner;
    }
